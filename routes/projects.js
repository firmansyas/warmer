...
module.exports = function(db) {
  ...
  router.get('/details/:id/overview', userChecker, function(req, res){
    let trackerQuery = `SELECT (SELECT count(*) FROM issues WHERE tracker = 'Bug') as Bug,(SELECT count(*) FROM issues WHERE tracker = 'Feature') as feature, (SELECT count(*) FROM issues WHERE tracker = 'Support') as Support WHERE projectid = ${req.params.id}`
